...
// let query = `SELECT kriteria.id_kriteria, subkriteria.id_kriteria, karyawan.id_karyawan AS id_karyawan, subkriteria.id_subkriteria, subkriteria.bobot AS bobot_subkriteria FROM penilaian INNER JOIN karyawan ON penilaian.id_karyawan=karyawan.id_karyawan INNER JOIN subkriteria ON penilaian.id_subkriteria=subkriteria.id_subkriteria INNER JOIN kriteria ON penilaian.id_kriteria=kriteria.id_kriteria`;

// let querybenar = `SELECT kriteria.id_kriteria, kriteria.bobot as bobot_kriteria, karyawan.id_karyawan AS id_karyawan, subkriteria.bobot AS bobot_subkriteria FROM penilaian INNER JOIN karyawan ON penilaian.id_karyawan=karyawan.id_karyawan INNER JOIN subkriteria ON penilaian.id_subkriteria=subkriteria.id_subkriteria INNER JOIN kriteria ON penilaian.id_kriteria=kriteria.id_kriteria`;
